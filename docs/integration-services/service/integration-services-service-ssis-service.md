...
**Note**: If the service account of SQL Server Agent didn't has the Integration Services DCOM **[Launch and Activation Permissions]** permission, system event log will be logged the following event while SQL Server Agent execute the SSIS package jobs.
 ...
 **The application-specific permission settings do not grant Local Activation permission for the COM Server application** with CLSID
 ...
 and APPID {xxxxxxxxxxxxxxxxxxxxxxxxxxxxx} 
